...
import { getRank, getScore, getHighScore, getLeaderboard, addEntry } from "./handlers/bukGames";
...
pollHandler.post("/poll/pickWinner", adminCheck, (req : Request, res : Response) => pickWinner(firestore, req, res));
pollHandler.post("/poll/updateStats", adminCheck, (req : Request, res : Response) => updatePollStats(firestore, req, res));
pollHandler.post("/poll/start", adminCheck, (req : Request, res : Response) => startPoll(firestore, req, res));
pollHandler.post("/poll/clearAll", adminCheck, (req : Request, res : Response) => pollClearAll(firestore, req, res));
pollHandler.post("/poll/generate", (req : Request, res: Response) => generatePoll(firestore, req, res));
...
bukGamesHandler.get("/bukGames/rank", (req : Request, res : Response) => getRank(firestore, req, res));
bukGamesHandler.get("/bukGames/score", (req : Request, res : Response) => getScore(firestore, req, res));
bukGamesHandler.get("/bukGames/highscore", (req : Request, res : Response) => getHighScore(firestore, req, res));
bukGamesHandler.get("/bukGames/leaderboard", (req : Request, res : Response) => getLeaderboard(firestore, req, res));
