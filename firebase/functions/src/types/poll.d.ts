...
export interface PollRefs {
    ...
    response? (personId: number, questionId: number | string): FirebaseFirestore.DocumentReference,
    ...
    qaShard? (questionId: number | string, answerId: number | string, index: number): FirebaseFirestore.DocumentReference,
}
...
export interface PollActions {
    ...
    setPollResponse? (userDoc: FirebaseFirestore.DocumentData, questionId: number | string, selectedAnswers: Array<string>): Promise<FirebaseFirestore.DocumentReference>,
    pickRandomWinner? (questionId: number | string): Promise<{} | boolean>,
    updatePollStats? (currentQuestionId: number | string): Promise<{} | PollStats>,
    updateResponseStats? (bucketPathsCommaSep: string, questionIdArray: Array<number | string>): {},
}
