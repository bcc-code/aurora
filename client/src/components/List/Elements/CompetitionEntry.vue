<template>
    <li class="mb-2 xl:w-1/4 lg:w-1/3 md:w-1/2 w-full px-4">
        <div class="cursor-pointer transition duration-500 p-0 rounded relative bg-blue-800">
            ...
            <div class="flex justify-evenly text-2xl px-6 py-2">
                <button type="button" @click.stop="approve"><i class="fas fa-thumbs-up text-green-500"></i></button>
                <button type="button" @click.stop="reject"><i class="fas fa-trash-alt text-red-500"></i></button>
            </div>
        </div>
    </li>
</template>
