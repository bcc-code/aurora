                    ...
                    <section v-if="!karaokeMode" class="w-full flex flex-1 items-center" :class="{'pl-8' : isNormal }">
                        ...
                        <template v-else>
                            ...
                            <div class="w-full flex pb-3">
                                <Information class="self-end flex pb-3" v-if="screen.options.component === ScreenAComponents.INFORMATION && hasInformation" size="big" showTitle :showBackground="false" :information="screen.options.information.information" :event="event" />
